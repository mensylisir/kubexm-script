...
step::kubeadm.join.master.copy.config::rollback() { return 0; }

step::kubeadm.join.master.copy.config::targets() {
  : "${KUBEXM_ROOT:?KUBEXM_ROOT is required}"
